const Header = () => {
    return (
      <div className=" h-[41vw] md:h-[34vw]  mb-4 bg-[url('/header_img.png')] bg-no-repeat bg-contain relative">
        <div className="absolute flex flex-col items-start gap-[1.5vw] sm:max-w-[60%] max-w-[70%] bottom-[10%] left-[6vw] animate-fadeIn lg:max-w-[55%]">
